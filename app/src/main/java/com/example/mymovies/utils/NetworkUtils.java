...
public class NetworkUtils {
    ...
    // параметр отвечает , за минимальное количество голосов
    private static final String PARAMS_MIN_VOTE_COUNT = "vote_count.gte";

    private static final String API_KEY = "6eac2dd921c8f50ad10cfa7e88252786";
    //   private static final String PARAMS_VALUE = "ru-RU";
    ...
    //////////////////////////////////////////////////////////////////////////загрузка REVIEWS
    // создаеь url ссылку , для получения фильма , по id
    ...
    public static URL buildURL(int sortBy, int page, String lang) {
        // создаем ссылку
        URL result = null;
        // вид сортировки, задаем от константы
        String methodOfSort;
    ...
    // на входе отправляем вит сортировки
    //          номер страницы
    // на выходе получаем JSONObject
    ...
    public static class JSONLoader extends AsyncTaskLoader<JSONObject> {
        /// данная переменная будет использоваться , для того ,что бы
        // если прервалась загрузка , то от сюда будем считать ссылку
        private Bundle bundle;
        // добаляем слушателя , который будет отвечать за загрузку
        ...
        // переопределяем метод загрущика
        @Override
        protected void onStartLoading() {
            ...
            // продолжить загрузку , если прервались
            forceLoad();
        }
        ...
        public JSONObject loadInBackground() {
            // проверяем не пустойли bundle
            if (bundle == null) {
                return null;
            }
            /// загружаем с bundle по ключу url
            ...
            // суда будем возращать результат
            JSONObject result = null;
            if (url == null) {
                return null;
            }
    ...
    // по ссылке url получаем  JSONObject объект
